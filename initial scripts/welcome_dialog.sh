...
--message "Hi $firstName,\n\nWe're going to get you set-up and install some necassary applications. \n\nWhen the installation is finished, you will see a button with **Restart**. Klik daarop om je MacBook opnieuw op te starten en de installatie af te ronden.\n\n Dit kan even duren, dus heb geduld...." \
--messagefont "size=14" \
